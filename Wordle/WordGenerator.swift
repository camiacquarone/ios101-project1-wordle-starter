...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE", "AUDIO", "APPLE", "BAKER", "CANDY", "DELTA", "EAGLE", "FLAME", "GRAPE", "HOUSE", "KARMA", "LEMON", "MANGO", "PEARL", "QUEEN", "RAVEN", "SUGAR", "TIGER", "URBAN", "VIVID", "XENON", "YACHT"]
